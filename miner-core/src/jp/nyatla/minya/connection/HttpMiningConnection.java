...
public class HttpMiningConnection implements IMiningConnection {
	...
	public HttpMiningConnection(String i_url, String i_userid, String i_password) throws MinyaException {
		try {
			...
			throw new MinyaException("Authorization failed." + "{url:" + i_url + "," + "user:" + i_userid + ","
					+ "pass:" + i_password + ")");
	...
	public MiningWork getWork() throws MinyaException {
		/*
		 * content={"result":{"midstate":
		 * "14bad41483b9e1147a71cab45b59bdf9c970fdedbf34cb9ece9842d260fd22ea","data":
		 * ""
		 * ,"hash1":
		 ...
		 * target=0000000000000000000000000000000000000000000000000000efe300000000
		 * header=
		 * 02000000d1b20578cc1ada99978ea7777952c2f1cce3dfe0ab98d7325cb91c5d39501c6c88d34a93a6a865d5aa79a71acc66c6989f0f86f18bb0239c7c6b9d6e6f72b416198ba852efe3001d00000000
	...
	public void submitWork(MiningWork i_work, int i_nonce) throws MinyaException {
		try {
			String request = "{\"method\": \"getwork\", \"params\": [ \"" + i_work.makeSubmitData(i_nonce)
					+ "\" ], \"id\":1}";
			String content = this.getJsonRpcResult(request);
